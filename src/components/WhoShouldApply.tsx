...
export default function WhoShouldApply() {
  const founderCategories = [
    ...
    { icon: DollarSign, text: 'Stablecoin payments, SME finance, cross-border remittance' },
    { icon: Home, text: 'Real-world assets, data/IP, tokenized credentials' },
    { text: 'Teams with deep technical capacity & enterprise-ready use cases' }
  ];
        ...
        <div className="grid md:grid-cols-2 gap-8 max-w-6xl mx-auto">
          ...
          <div className="bg-[#f6f4ee] rounded-2xl p-8 border border-black/10">
            ...
            <p className="text-base md:text-lg text-black/70 mb-6 leading-relaxed">
              Early-stage teams (idea → Series A) building in:
            </p>
